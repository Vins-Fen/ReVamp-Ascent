...
<%@ page import="dataAccess.DAO.ArticoloDAO, dataAccess.DAO.ImmagineArticoloDAO, dataAccess.DAO.CategoriaDAO" %>
<%@ page import="dataAccess.JavaBeans.Articolo, dataAccess.JavaBeans.ImmagineArticolo, dataAccess.JavaBeans.Categoria" %>
